...
export default function BuildingPoints({ setHoveredId, hoveredId }: BuildingPointsProps) {
    const Towers = [
        ...
        { id: 6, name: "Hiranandani Estate", polyconPoints: "2,466,254,458,511,453,712,514,799,758,895,898,871,988,460,1033,8,1139", hoveredColor: "" },
        ...
        { id: 11, name: "Forest ave road", polyconPoints: "3,1223,11,1268,1030,1050,1244,1011,1430,974,1628,934,1832,886,1957,862,1933,838,1816,862,1663,897,1533,923,1417,950,1319,966,1226,995,1131,1003,1019,1021,895,1050,802,1064,710,1085,620,1106", hoveredColor: "" },
        // { id: 12, name: "Forest ave road", polyconPoints: "1311,966,1986,818,1996,855,1332,995", hoveredColor: "" },
        { id: 12, name: "Forest ave road", polyconPoints: "2150,714,2425,781,2142,820,2126,794", hoveredColor: "" },

        { id: 13, name: "Villa grand road", polyconPoints: "876,844,892,836,1080,982,1038,1003", hoveredColor: "" },
    ];
    return (<>
        <svg
